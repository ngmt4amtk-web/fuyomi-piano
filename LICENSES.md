...
`js/staff.js` は Bravura 1.204 の次のグリフ輪郭を SVG パス文字列として埋め込んで利用しています。
実行時にフォントファイルを読み込むことはありません。
...
Font metadata copyright notice:

> Copyright © 2016, Steinberg Media Technologies GmbH (http://www.steinberg.net/), with Reserved Font Name "Bravura".

Bravura distribution copyright notice:

> Copyright © 2015, Steinberg Media Technologies GmbH (http://www.steinberg.net/), with Reserved Font Name "Bravura".

Bravura is licensed under the SIL Open Font License, Version 1.1. The official license text is also available at
